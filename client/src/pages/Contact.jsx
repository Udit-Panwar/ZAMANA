        ...
        <div className="mt-20 animate-fade-in-up">
          ...
          {/* <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { q: "Do you offer phone support?", a: "Yes! Call us during business hours for immediate assistance" },
              { q: "Can I visit your office?", a: "Absolutely! Schedule an appointment and visit our office in Agra" }
            ].map((faq, idx) => (
              <div 
                key={idx} 
                className="group bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition-all duration-500 hover:shadow-lg hover:shadow-pink-500/20"
                style={{ animationDelay: `${idx * 100}ms` }}
              >
                <h4 className="text-lg font-bold text-white mb-3 group-hover:text-pink-400 transition-colors duration-300">
                  {faq.q}
                </h4>
